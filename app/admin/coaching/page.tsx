    ...
    <main className="min-h-screen bg-[#07090D] py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/admin/users"
                className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 hover:bg-emerald-500/25 transition-all text-sm font-medium"
              >
                <Sparkles size={16} />
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-black/40 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors text-sm"
              >
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 reticle-box">
          ...
          <div className="space-y-12">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <span className="w-3 h-3 bg-emerald-400 animate-pulse" />
                  <h2 className="text-xl font-bold text-white flex items-center gap-2">
                    Élèves en coaching actuel
                    <span className="px-2.5 py-0.5 text-xs font-semibold bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
              ...
              {coachedStudents.length === 0 ? (
                <div className="reticle-box p-8 text-center border border-white/5 bg-white/[0.02]">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-200 flex items-center gap-2">
                  Autres élèves
                  <span className="px-2.5 py-0.5 text-xs font-semibold bg-white/10 text-gray-400 border border-white/10">
              ...
              {regularStudents.length === 0 ? (
                <div className="reticle-box p-6 text-center border border-white/5 text-gray-500 text-sm">
